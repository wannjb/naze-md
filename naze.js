...
rules = `┌──⭓ *Rules BOT*
│
│ *Intinya Jangan Spam Ya Anak Anj❗*
│
└───────⭓`
let buttons = [{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'Owner', buttonText: { displayText: '👑Sewa' }, type: 1 }]
...
╰──❍`
            ...
            let buttons = [{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: '❗Rules' }, type: 1 },{ buttonId: 'Owner', buttonText: { displayText: '👤Owner' }, type: 1 }]
...
_Donasi Ngab_\n_Jangan Ngarep Free Mulu_`
                let buttons = [{ buttonId: 'Rules', buttonText: { displayText: '❗Rules' }, type: 1 },{ buttonId: 'Owner', buttonText: { displayText: '👤Owner' }, type: 1 }]
